...
os.makedirs('html_lotes', exist_ok=True)
...
<head>
  ...
  <title>Detalhes do Produto - Lote {lote}</title>
...
<body>
  <div class="container">
    <div class="header">
      <img src="https://airslaid.github.io/rastreamento-lotes/html_lotes/Images/logo.png" alt="Logo">
...
for _, row in df.iterrows():
    ...
    html_path = os.path.abspath(f'html_lotes/lote_{nome}.html')
    ...
    # URL pública para GitHub Pages
    url_publica = f"https://airslaid.github.io/rastreamento-lotes/html_lotes/lote_{nome}.html"
    gera_html_estilizado(lote, dados, html_path)
    gera_qrcode(url_publica, qr_path)
